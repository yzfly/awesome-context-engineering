...
- **[gcontext](https://github.com/bleak-ai/gcontext)**: Version-controlled context modules your coding agent navigates itself: folders of markdown plus an llms.txt index, loaded per task. Plain files, no RAG or vector DB.
